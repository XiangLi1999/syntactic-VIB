...
def fine_parse(args):
    ...
    if args.test == 'yes':
        ...
        corpus_test, batch_idx_test, en_batch_test = corpus_test[1:20], batch_idx_test[1:20], en_batch_test[1:20]
    else:
        en_batch_test = None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_decay2', default=1e-4, type=float, help='learning rate')
    parser.add_argument('--beta', default = 1e-3, type=float, help='beta')
    parser.add_argument("--type_token_reg", type=str, dest="type_token_reg", default='yes')
    parser.add_argument('--gamma', default=1e-3, type=float, help='gamma')
    ...
    parser.add_argument('--test', default='no', type=str, help='test set')
    ...
    # parser.add_argument('--dataset', default='/Users/xiangli/documents/UD_English/en-ud-train.conllu',
    #                     type=str, help='dataset name')
    # parser.add_argument('--dataset_dev', default='/Users/xiangli/documents/UD_English/en-ud-dev.conllu',
    #                     type=str, help='dataset for dev name')
    # parser.add_argument('--dataset_test', default='/Users/xiangli/documents/UD_English/en-ud-test.conllu',
    #                     type=str, help='dataset for test name')
    parser.add_argument('--embedding', default='/Users/xiangli/documents/glove/glove.6B.50d.txt', type=str,
                        help='embedding filename') #glove.6B.200d.txt
    parser.add_argument('--save_path', default='model_checkpoint_beta=0.1', type=str, help='save filename')
    parser.add_argument('--out_path', default='model_checkpoint_beta=0.1', type=str, help='output filename')
    parser.add_argument('--checkpoint_path', default='model_checkpoint_beta=0.1', type=str, help='checkpoint filename')
    parser.add_argument('--mode',default='train', type=str, help='train or test')
    parser.add_argument("--task", type=str, dest="task", default="VIB_continuous")
    parser.add_argument("--sample_method", type=str, dest="sample_method", default="iid",
        help="three options: iid and argmax")
    parser.add_argument("--embedding_source", type=str, dest="embedding_source", default='elmo_1')
    parser.add_argument("--tag_dim", type=int, dest="tag_dim", default=15)
    parser.add_argument("--sample_size", type=int, dest="sample_size", default=5)

    parser.add_argument("--foreign", type=str, dest="foreign", default="no")
    parser.add_argument("--lang", type=str, dest="lang", default="ar")
    parser.add_argument("--cuda", type=int, dest="cuda", default=1)
    parser.add_argument("--elmo_model_path", type=str, dest="elmo_model_path", default='/Users/xiangli/Downloads/136')
    parser.add_argument("--elmo_option_path", type=str, dest="elmo_option_path", default='/Users/xiangli/Downloads/136')
    parser.add_argument("--activation", type=str, dest="activation", default="tanh")
    parser.add_argument("--projective", type=str, dest="projective", default="no", help='non-proj \
        means accept all, proj means only accept proj')
...
# ========================================================================================================
    ...
    parser.add_argument("--objective", type=str, dest="objective", default="neg_log_prob")
    parser.add_argument("--PCA", type=str, dest="PCA", default="pca")
    parser.add_argument("--max_sent_len", type=int, dest="max_sent_len", default=30)
    parser.add_argument("--word_threshold", type=int, dest="word_threshold", default=1)
